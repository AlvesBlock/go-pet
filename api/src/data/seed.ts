...
import { ChatMessage, Driver, Incident, Pet, Ride, SupportTicket } from '../domain/types';
...
export const drivers: Driver[] = [
  {
    ...
    status: 'ONLINE',
    vehicle: { model: 'Doblò Adventure 2022', plate: 'FHP2B19', category: ['PLUS', 'VET', 'SUV'] },
    etaMinutes: 8,
  },
  {
    id: 'drv_2',
    ...
    status: 'ON_TRIP',
    vehicle: { model: 'Spin LTZ 2021', plate: 'GVX3F12', category: ['BASIC', 'PLUS'] },
    etaMinutes: 4,
  },
  {
    id: 'drv_3',
    ...
    status: 'ONLINE',
    vehicle: { model: 'Renegade 2023', plate: 'GZF8A88', category: ['SUV', 'VET'] },
    etaMinutes: 11,
  },
];
...
export const rides: Ride[] = [
  {
    ...
    scheduledAt: addMinutes(now, 15).toISOString(),
    ...
    timeline: [
      {
        ...
        at: subMinutes(now, 20).toISOString(),
      },
      {
        id: 'evt_2',
        ...
        at: subMinutes(now, 10).toISOString(),
      },
      {
        id: 'evt_3',
        status: 'EN_ROUTE_PICKUP',
  ...
  },
  {
    ...
    scheduledAt: addMinutes(now, 45).toISOString(),
    ...
    timeline: [
      {
        ...
        at: subMinutes(now, 40).toISOString(),
      },
      {
        id: 'evt_5',
        ...
        at: subMinutes(now, 12).toISOString(),
      },
      {
        id: 'evt_6',
        status: 'PET_ONBOARD',
...
export const incidents: Incident[] = [
  {
    ...
    severity: 'medium',
    status: 'triaged',
    createdAt: subMinutes(now, 7).toISOString(),
  },
  {
    id: 'inc_2',
    rideId: 'ride_2',
...
export const messages: ChatMessage[] = [
  {
    ...
    at: subMinutes(now, 6).toISOString(),
  },
  {
    id: 'msg_2',
    rideId: 'ride_1',
  ...
  },
  {
    ...
    at: subMinutes(now, 4).toISOString(),
  },
  {
    id: 'msg_4',
    rideId: 'ride_1',
